...
var zlalert = {
    ...
    */
    ...
    'alertInfoConfirm': function (title, msg, confirmCallback) {
        args = {
            'title': title,
            'text': msg,
            'type': 'warning'
    ...
    */
    ...
    /*
     ...
     参数：
         ...
         - timer：超时时间（必传）
 */
    'alertSuccessToastWithTime': function (msg, timer) {
        swal({
            'msg': msg,
            'timer': timer,
        });
        this.alertToast(msg, 'success', timer)
    },
    ...
    /*
        ...
        参数：
            ...
            - type：toast的类型
    */
    'alertToast': function (msg, type, timer) {
        if (!timer) {
            timer = 1000
        }
        swal({
